...
#define MIDERR	0x4E
#define MIDRJC	0x4F
#define MIDAPR	0x35	/* All Tone Parameters with Tone names */
#define MIDIPR	0x36	/* Individual Tone Parameter */
...
int gettone(int ajparam[NPARAM], char ajname[11]);	/* get one patch */
...
sendparam(char param, char value);		/* send one parameter */
